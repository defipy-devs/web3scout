...
class Conversion:
    ...
    def decode_data(self, data: str) -> list[bytes]:
    ...
    def convert_uint256_bytes_to_address(self, raw: bytes | HexBytes) -> ChecksumAddress:
    ...
    def convert_int256_bytes_to_int(self, bytes32: bytes, *, signed: bool = False) -> int:
    ...
    def convert_uint256_string_to_address(self, bytes32: str) -> ChecksumAddress:
    ...
    def convert_uint256_string_to_int(self, bytes32: str, *, signed: bool = False) -> int:
    ...
    def convert_jsonrpc_value_to_int(self, val: str | int) -> int:
